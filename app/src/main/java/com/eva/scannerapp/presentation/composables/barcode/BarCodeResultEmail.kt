...
fun BarCodeEmailResults(
	...
	Column(modifier = modifier) {
		SuggestionChip(
			...
			label = { Text(text = stringResource(id = R.string.barcode_results_helper_send_email)) },
			icon = {
				Icon(
					imageVector = Icons.Outlined.Email,
					contentDescription = stringResource(id = R.string.barcode_results_helper_send_email),
				)
			},
